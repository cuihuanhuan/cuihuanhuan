---
title: Phpstorm&webstorm安装使用设置
categories: Phpstorm&webstorm
tags: Phpstorm&webstorm
---
...
可以用phpstorm2016,感觉比phpstorm2017顺手
    ...
    1.phpstorm2016的主题还可以不需要自己再换主题了
    2.激活和汉化和上文一致

-----------------------------------------------------华丽的分割线----------------------------------------------------------------


3.让phpstorm支持codeigniter自动补全
    如果你用MX(不是基于纯粹ci框架上的项目,而是在ci基础上做处理的第三方的东西)
...
```
1.软件许可
    搜webstorm license server
    选择license server 输入http://www.aku.vn/idea
2.汉化
    https://github.com/ewen0930/WebStorm-Chinese
    下载下来后,点击里面的cmd
3.导入代码
```
