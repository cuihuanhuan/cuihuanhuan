 ...
 case 1 "HASH分区表(一普通索引)：建立：指定分区名称，为每个分区指定表空间" 0
        src_sql:
            drop table "dds_dept"
            /
 ...
 case 2 "HASH分区表(一普通索引)：INSERT 记录" 0
        src_sql:
            drop table "dds_dept"
            /
            create table "dds_dept" ( deptno number, deptname varchar2(32), salmount number )
 ...
 case 3 "HASH分区表(一普通索引)：UPDATE 记录" 0
        src_sql:
            drop table "dds_dept"
            /
            create table "dds_dept" ( deptno number, deptname varchar2(32), salmount number )
 ...
 case 4 "HASH分区表(一普通索引)：增加分区：分区未命名" 0
        src_sql:
            drop table "dds_dept"
            /
            create table "dds_dept" ( deptno number, deptname varchar2(32), salmount number )
 ...
 case 5 "HASH分区表(一普通索引)：增加分区：分区有命名" 0
        src_sql:
            drop table "dds_dept"
            /
            create table "dds_dept" ( deptno number, deptname varchar2(32), salmount number )
 ...
 case 7 "HASH分区表(一普通索引)：分区TRUNCATE" 0
        src_sql:
            drop table "dds_dept"
            /
            create table "dds_dept" ( deptno number, deptname varchar2(32), salmount number )
 ...
 case 8 "HASH分区表(一普通索引)：分区: 交换分区: 交换第一个分区" 0
        src_sql:
            drop table swap_t
			/
            drop table "dds_dept"
 ...
 case 9 "HASH分区表(一普通索引)：分区: 交换分区: 交换中间的分区" 0
        src_sql:
            drop table swap_t
            /
            drop table "dds_dept"
 ...
 case 10 "HASH分区表(一普通索引)：分区: 移动分区（移动到相同表空间）:第一个分区" 0
        src_sql:
            drop table swap_t
            /
            drop table "dds_dept"
 ...
 case 11 "HASH分区表(一普通索引)：分区: 移动分区（移动到相同表空间）:中间分区" 0
        src_sql:
            drop table "dds_dept"
            /
            create table "dds_dept" ( deptno number, deptname varchar2(32), salmount number )
 ...
 case 12 "HASH分区表(一普通索引)：分区: 移动分区（移动到相同表空间）:最后一个分区" 0
        src_sql:
 ...
 case 13 "HASH分区表(一普通索引)：分区: 移动分区（移动到其它表空间）" 0
        src_sql:
            drop table swap_t
            /
            drop table "dds_dept"
